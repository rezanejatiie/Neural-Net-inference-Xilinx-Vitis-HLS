set C_TypeInfoList {{ 
"hw_dot_product" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"a": [[], {"array": [ {"scalar": "int"}, [10]]}] }, {"b": [[], {"array": [ {"scalar": "int"}, [10]]}] }, {"out": [[], {"reference":  {"scalar": "int"}}] }],[],""]
}}
set moduleName hw_dot_product
...
set C_modelName {hw_dot_product}
set C_modelType { void 0 }
set C_modelArgList {
	{ a int 32 regular {array 10 { 1 1 } 1 1 }  }
	{ b int 32 regular {array 10 { 1 1 } 1 1 }  }
